...
export interface ServiceCatalog {
  ...
  "catalog.applyCouponToCart": {
    input: { cartId: string; cartToken?: string; code: string };
  ...
  "catalog.listCartOffers": {
    input: { cartId: string; cartToken?: string; justAddedVariantId?: string };
  ...
  "catalog.quoteCartPromotions": {
    input: { cartId: string; cartToken?: string; couponCode?: string; subtotalMinor: number; shippingMinor: number; currency: string };
  ...
  "catalog.saveCart": {
    input: { cartId: string; cartToken?: string; name: string };
    output: { cart: { id: string; token: string | null; contactId: string | null; currency: string; kind: "cart" | "saved"; status: "open" | "converted" | "abandoned"; name: string | null; lastActivityAt: string; abandonedAt: string | null; createdAt: string; updatedAt: string; [key: string]: unknown }; lines: { id: string; cartId: string; variantId: string; locationId: string | null; quantity: number; reservationId: string | null; galleryId: string | null; assetId: string | null; createdAt: string; updatedAt: string; sku: string; productName: string; requiresShipping: boolean; weightG: number | null; lengthMm: number | null; widthMm: number | null; heightMm: number | null; unitAmountMinor: number | null; lineTotalMinor: number | null; priceAvailable: boolean; priceReason: string | null; stock: { tracked: false; available: boolean; quantity?: number } | { tracked: true; available: boolean; backordered: boolean; restockAt: string | null; onHand: number; reserved: number; incoming: number; canPromise: number }; [key: string]: unknown }[]; subtotalMinor: number; allPriced: boolean; allAvailable: boolean };
  };
  "catalog.sendGiftCard": {
  ...
  "catalog.setCartItemQuantity": {
    input: { cartId: string; cartToken?: string; variantId: string; quantity: number; locationId?: string };
    output: { cart: { id: string; token: string | null; contactId: string | null; currency: string; kind: "cart" | "saved"; status: "open" | "converted" | "abandoned"; name: string | null; lastActivityAt: string; abandonedAt: string | null; createdAt: string; updatedAt: string; [key: string]: unknown }; lines: { id: string; cartId: string; variantId: string; locationId: string | null; quantity: number; reservationId: string | null; galleryId: string | null; assetId: string | null; createdAt: string; updatedAt: string; sku: string; productName: string; requiresShipping: boolean; weightG: number | null; lengthMm: number | null; widthMm: number | null; heightMm: number | null; unitAmountMinor: number | null; lineTotalMinor: number | null; priceAvailable: boolean; priceReason: string | null; stock: { tracked: false; available: boolean; quantity?: number } | { tracked: true; available: boolean; backordered: boolean; restockAt: string | null; onHand: number; reserved: number; incoming: number; canPromise: number }; [key: string]: unknown }[]; subtotalMinor: number; allPriced: boolean; allAvailable: boolean };
  };
  "catalog.setDefaultVariant": {
  ...
  "galleries.addToCart": {
    input: { sessionToken: string; itemId: string; variantId: string; cartId: string; cartToken?: string; quantity?: number };
    output: { ok: true };
  };
  "galleries.approveRound": {
  ...
  "settings.getDesign": {
    input: Record<string, never>;
    output: { theme: { light: { paper: string; surface: string; surfaceMuted: string; field: string; ink: string; inkMuted: string; rule: string; accent: string; onAccent: string; accentSoft: string; success: string; successSoft: string; warning: string; warningSoft: string; danger: string; dangerSoft: string; onDanger: string; focus: string }; dark: { paper: string; surface: string; surfaceMuted: string; field: string; ink: string; inkMuted: string; rule: string; accent: string; onAccent: string; accentSoft: string; success: string; successSoft: string; warning: string; warningSoft: string; danger: string; dangerSoft: string; onDanger: string; focus: string } }; extras: { fontSans?: string; fontMono?: string; radius?: string; motion?: string; measure?: string; gutter?: string }; logoAssetId: string | null; origin: "owner" | "system" };
  };
  "settings.getModuleConfig": {
    input: { module: string };
