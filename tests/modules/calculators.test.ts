...
const STEPS = [
  {
    ...
    left: { kind: "input" as const, key: "amount" },
    right: { kind: "fact" as const, factKey: RATE_KEY },
  },
  {
    key: "monthly",
    label: "Interest for a month",
    op: "divide" as const,
    left: { kind: "step" as const, key: "yearly" },
    right: { kind: "literal" as const, value: 12 },
  },
];
    ...
    const problems = configurationProblems(INPUTS, [
      {
        ...
        label: "First",
        op: "add" as const,
        left: { kind: "step" as const, key: "second" },
      ...
      [
        {
          ...
          label: "Per person",
          op: "divide" as const,
          left: { kind: "literal" as const, value: 100 },
          right: { kind: "input" as const, key: "people" },
        },
      ],
