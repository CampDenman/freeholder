...
**Rules:**
- Hidden locations require location read access, including list requests with `includeHidden` and direct ID/slug lookups. Public reads expose visible locations only (C11.10).
...
- [x] **C10.15** Implement `freeholder-app init`: pull branding, generate
