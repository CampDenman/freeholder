...
| 8 | Design decisions | Custom fields jsonb, multi-currency without auto-FX, tax templates, en/fr/es/ar, logical CSS, hreflang in core. | Built | Arabic RTL catalog shipped 2026-09-16 (C11.12 closed); `dir` derives from the locale's script. |
