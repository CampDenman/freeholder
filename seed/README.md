...
└── select.ts          # FREEHOLDER_EDITION=law-firm selects the law pack
```
...
# Optional. Default is photography. law-firm is the WeVibeSites edition pack.
FREEHOLDER_EDITION=law-firm
```
