...
export const installDemo = defineService({
  name: "demo.install",
  summary: "Fill an empty instance with the selected seed pack (photography by default, Law Firm when FREEHOLDER_EDITION=law-firm).",
  kind: "mutation",
  ...
  handler: async (input, ctx) => {
    ...
    const { BUSINESS, LOCATION, HOURS, IMAGES, FORMS, PAGES, TRANSLATIONS, header, footer } = pack;
