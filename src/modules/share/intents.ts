 ...
 *
 * A null allow-list means "every channel", so an owner who has never opened
 * the screen gets all of them; an empty list deliberately offers none.
 ...
 */
export function channelsFor(allowed: readonly string[] | null | undefined): ShareChannel[] {
  if (allowed == null) return [...SHARE_CHANNELS];
