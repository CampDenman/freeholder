...
export const shareTargets = pgTable(
  "share_targets",
  {
    ...
    /**
     * Channels this entity may be shared to. Null means every channel the
     * instance offers; an empty array means none.
     */
    // Null means every channel; an empty array means none. Conflating those
    // two states makes an owner who unticks every box enable everything.
