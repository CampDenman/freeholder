...
export default defineModule({
  ...
  events: {
    ...
    emits: [
      ...
      "conversation.bulk",
      "conversation.assistantEscalated",
      "messaging.numbersImported",
      "messaging.registrationChanged",
      "messaging.complianceHandled",
      "messaging.keywordRuleCreated",
      "messaging.keywordRuleUpdated",
      "messaging.keywordRuleDeleted",
      "messaging.keywordHandled",
      "messaging.siteChatStarted",
      "messaging.siteChatEnded",
      "message.received",
      "message.sent",
      "message.undelivered",
      "contactImport.started",
      "contactImport.committed",
      "contactImport.reverted",
      "signupContactImport.policyChanged",
      "signupContactImport.previewed",
      "signupContactImport.skipped",
      "connection.contactsConnected",
      "connection.contactsDisconnected",
      "import.committed",
      "import.published",
      "import.rolledBack",
      "agent.connected",
